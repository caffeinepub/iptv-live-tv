...
export class Backend implements backendInterface {
    ...
    async addChannel(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<ChannelId> {
        if (this.processError) {
            try {
                const result = await this.actor.addChannel(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFavourites(): Promise<Array<Channel>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFavourites();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async toggleFavourite(arg0: ChannelId): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async updateChannel(arg0: ChannelId, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string): Promise<void> {
        if (this.processError) {
            try {
